...
def djikstra(qinit, qgoal, graph, x_array, y_array, astar=False):  #If you want to use Astar, you must set astar = true
	...
	N = len(graph.nodes) # How many nodes I have
	...
	while unvisited_nodes:
		...
		for childNode, weight in graph.nodes[minNode].edges.items():
	...
	while currentNode != qinit:
		...
		try:
			...
			total_cost += graph.nodes[currentNode].edges[predecessor[currentNode]]
